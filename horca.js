...
var palabras = ['ALURA', 'FRONTEND', 'HTML', 'ORACLE', 'JAVASCRIPT', 'LOGICA', 'PROGRAMACION', 'PYTHON'];
...
function mostrarVentanaDeAgregarPalabra() {
  document.getElementById("div-desaparece").style.display = "none";
  document.getElementById("agregar-palabra").style.display = "inline-block";
...
function guardarPalabra() {
  ...
  let nuevaPalabra = document.getElementById("input-nueva-palavbra").value;
  ...
  if(nuevaPalabra !== ""){
    ...
    alert("No Se Ha Escrito Ninguna Palabra")
  }
...
function iniciarJuego() {
  ...
  document.onkeydown = (e) => {
    ...
    if (letrasIncorrectas.length <= numeroDeErrores) {
      ...
      alert("Has llegado al Limite de letras incorrectas")
    }
